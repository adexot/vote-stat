    ...
    <main className="flex-container index-container">
      ...
      <div className="right-column">
        ...
        <p className="text-grey">
          ...
          <br />
          Get overviewof basic statistics about the electoral features of each
          state.
        </p>
        <div className="grid-container" id="candidates-list">
          ...
          <div className="grid-item-image-five">
            <p className="text-small">
              The incumbent President, Muhammadu Buhari won a re-election bid
              after winning the APC presidential primaries held on 29 September
              2018.
            </p>
          </div>
          ...
          <div className="grid-item-image-22 grid-text-box">
            <p className="text-small">
              The President of Nigeria is elected using a simple majority of the
              highest votes cast, as well as over 25% of the votes in at least
              two-thirds of states. The 360 members of the House of
              Representatives are elected using first-past-the-post voting in
              single-member constituencies, whilst the 109 members of the Senate
              are elected from 108 single-seat constituencies into which the
              States are divided (three each) and one single-seat constituency
              consisting the Federal Capital Territory, all by
          ...
          <div className="grid-item-image-36 grid-text-box">
            <p className="text-small">
              ...
              presidential candidate will be duly elected after attaining both
              the highest number of votes cast, and having received at least a
              quarter of the votes at each of at least two-thirds of the 36
              states and the Federal Capital Territory (FCT). If no candidate
              satisfies the requirement, a second election will be held between
              the two leading candidates within seven days from the
